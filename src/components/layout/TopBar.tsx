...
const APP_QDN_NAME = getOwnQdnName('Groups');
const APP_QDN_IDENTIFIER = 'Groups';
    ...
    >
      ...
      <Box sx={{
        ...
        {notificationsSupported && (
          <Tooltip title={notificationsEnabled ? 'Notify me of group invites and join requests' : 'Notifications off'} placement="bottom">
            <IconButton
              size="small"
